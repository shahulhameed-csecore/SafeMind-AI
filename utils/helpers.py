...
def generate_ai_response(user_input, chat_history, user_lang='en'):
    ...
    try:
        ...
        print(f"⚠️ Gemma 31B Failed ({primary_error}). Initiating Gemma 9B Failover...")
        
        # 🚀 PLAN B: Fallback to the highly stable, lightweight Gemma model
        try:
            if not gemma_client: raise ValueError("Client offline.")
            ...
            english_reply = chat_completion.choices[0].message.content
            print("✅ Response generated by: GEMMA 9B (Plan B)")
