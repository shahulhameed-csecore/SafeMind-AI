...
# 🌟 100% PURE GEMMA 4 via Google AI Studio (Free & Stable)
try:
    gemini_client = genai.Client(api_key=os.getenv("GEMINI_API_KEY"))
    print("✅ Google AI Studio: Gemma 4 Initialized")
...
def generate_ai_response(user_input, chat_history, user_lang='en'):
    ...
    # 🚀 SINGLE STREAMLINED API CALL (Google AI Studio)
    try:
        ...
        print("✅ Response generated by: Google AI Studio (Gemma 4 26B)")
